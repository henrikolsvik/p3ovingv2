...
public class Statistics {
	...
	/**
	 * The total time that all completed processes have spent waiting in the CPU
	 * queue
	 */
	public long totalTimeSpentInReadyQueue = 0;
	/**
	 * The total time that all completed processes have spent in the CPU, should
	 * equal totalBusyCpuTime
	 */
	...
	/**
	 * The total time that all completed processes have spent performing I/O
	 * operations
	 */
	public long totalTimeSpentInIo = 0;

	/**
	 * The total number of times that all completed processes have been placed
	 * in the CPU queue
	 */
	...
	/**
	 * The time-weighted length of the CPU queue, divide this number by the
	 * total time to get average queue length
	 */
	...
	/**
	 * The time-weighted length of the I/O queue, divide this number by the
	 * total time to get average queue length
	 */
	...
	/**
	 * The number of process switches due to a Round Robin time quant having
	 * been spent (process switches due to a need for I/O or the completion of a
	...
	public void printReport(long simulationLength) {
		...
		System.out.println("Average throughput (processes per second):                    "
				+ (nofCompletedProcesses * 1000.0f) / simulationLength);
		System.out.println();
		...
		System.out.println("Fraction of CPU time spent processing:                        "
				+ totalBusyCpuTime * 100.0f / simulationLength + "%");
		System.out.println("Total CPU time spent waiting:                                 "
				+ (simulationLength - totalBusyCpuTime) + " ms");
		System.out.println("Fraction of CPU time spent waiting:                           "
				+ ((simulationLength - totalBusyCpuTime) * 100.0f / simulationLength) + "%");
		System.out.println();
